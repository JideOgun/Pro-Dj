...
function VideosPageContent() {
  ...
  const fetchVideos = async () => {
    try {
      ...
      const url = djId ? `/api/videos?djId=${djId}` : "/api/videos";
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {dj.videos.map((video) => (
                      ...
                      >
                        {/* Delete Button - only show for video owner or admin */}
                        {canDeleteVideo(video) && (
                          <div className="absolute top-2 right-2 z-10">
                            <button
                              ...
                              className="bg-black/70 hover:bg-red-600/90 backdrop-blur-sm rounded-full p-2 text-white transition-colors"
                              title="Delete video"
                            >
